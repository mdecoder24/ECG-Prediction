...
class ECG:
	...
	def DividingLeads(self,image):
		...
		#save the image
		fig.savefig('./assets/img/output_leads/Leads_1-12_figure.png')
		fig1 , ax1 = plt.subplots()
		fig1.set_size_inches(10, 10)
		ax1.imshow(Lead_13)
		ax1.set_title("Leads 13")
		ax1.axis('off')
		fig1.savefig('./assets/img/output_leads/Long_Lead_13_figure.png')
	...
	def PreprocessingLeads(self,Leads):
		...
		for x,y in enumerate(Leads[:len(Leads)-1]):
			...
			if (x+1)%3==0:
				...
				ax2[x_counter][y_counter].set_title("pre-processed Leads {} image".format(x+1))
				y_counter+=1
		fig2.savefig('./assets/img/output_leads/Preprossed_Leads_1-12_figure.png')
		...
		ax3.axis('off')
		fig3.savefig('./assets/img/output_leads/Preprossed_Leads_13_figure.png')
	...
	def SignalExtraction_Scaling(self,Leads):
		...
		fig4.savefig('./assets/img/output_leads/Contour_Leads_1-12_figure.png')
	...
	def DimensionalReduciton(self,test_final):
		...
		pca_loaded_model = joblib.load('./server/artifacts/PCA_ECG (1).pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load('./server/artifacts/Heart_Disease_Prediction_using_ECG (4).pkl')
